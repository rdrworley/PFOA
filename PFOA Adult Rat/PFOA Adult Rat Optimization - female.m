% M file automatically generated by acslXtreme on Wednesday, March 18, 2015 at 2:28:58 PM
...
use("optimization - female")

% Parameter Estimation Run : C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\PFOA Adult Rat Optimization - female.m
% Uses simulation : PFOA Adutl Rat.dll
disp("-------------------------------")

OpAdjustable = ["KEFFLUXC", ...
"KURINEC", ...
"RAFAPI"]
OpStartValues = [10, ...
1.6, ...
0.014]
OpConstrained = ["KEFFLUXC", ...
"KURINEC", ...
"RAFAPI"]
OpConstraints = [0, -1; ...
1.6, 0; ...
...
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\kemper_6_femalem.csv' @Format='Ascii' @Separator='Comma'
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\kemper_6_iv_femalem.csv' @Format='Ascii' @Separator='Comma'

OpData = [...
kemper_6_femalem( : , 1) kemper_6_femalem( : , 2)
kemper_6_iv_femalem( : , 1) kemper_6_iv_femalem( : , 2) ]
...
kemper_6_femalem( : , 1), kemper_6_femalem( : , 2), '*', 'pe_ca_1.aps');

start @NoCallback
plotHandle = plot( _t, _ca, ...
kemper_6_iv_femalem( : , 1), kemper_6_iv_femalem( : , 2), '*', 'pe_ca_2.aps');
...
uitext = strcat(uitext, "\fs24 Date:\tab\tab\cf1 Wednesday, March 18, 2015 at 2:28:58 PM\tab\cf0\par ");
uitext = strcat(uitext, "Script File:\tab\tab\cf1C:\\Program Files (x86)\\AEgis Technologies\\acslX\\PFOA\\PFOA Adult Rat\\PFOA Adult Rat Optimization - female.m\par ");
...
uitext = strcat(uitext, "C:\\Program Files (x86)\\AEgis Technologies\\acslX\\PFOA\\PFOA Adult Rat\\PFOA Adult Rat Optimization - female-params.m\par\par ");
...
mscript = "% Automatically generated through parameter estimation script 'PFOA Adult Rat Optimization - female.m'";
...
set @Preference = NoBackSlashEscapes
mScriptFileId = fopen('C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\PFOA Adult Rat Optimization - female-params.m', 'w');
