% M file automatically generated by acslXtreme on Thursday, January 22, 2015 at 5:50:20 PM
...
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\kemper_exp_5m.csv' @Format='Ascii' @Separator='Comma'
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\kemper_exp_6m.csv' @Format='Ascii' @Separator='Comma'
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\kemper_exp_7m.csv' @Format='Ascii' @Separator='Comma'
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\kemper_exp_8m.csv' @Format='Ascii' @Separator='Comma'
...
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\kudo_iv__low_dosem.csv' @Format='Ascii' @Separator='Comma'
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\PFOA Adult Rat\kudo_iv__low_dosem.csv' @Format='Ascii' @Separator='Comma'

OpData = [...
kemper_exp_5m( : , 1) kemper_exp_5m( : , 2)
kemper_exp_6m( : , 1) kemper_exp_6m( : , 2)
kemper_exp_7m( : , 1) kemper_exp_7m( : , 2)
kemper_exp_8m( : , 1) kemper_exp_8m( : , 2)
kemper_exp_6_ivm( : , 1) kemper_exp_6_ivm( : , 2)
kudo_iv__low_dosem( : , 1) kudo_iv__low_dosem( : , 2)
kudo_iv__low_dosem( : , 1) kudo_iv__low_dosem( : , 2) ]
...
kemper_exp_5m( : , 1), kemper_exp_5m( : , 2), '*', 'pe_ca_1.aps');
...
start @NoCallback
plotHandle = plot( _t, _ca, ...
kemper_exp_6m( : , 1), kemper_exp_6m( : , 2), '*', 'pe_ca_2.aps');
...
start @NoCallback
plotHandle = plot( _t, _ca, ...
kemper_exp_7m( : , 1), kemper_exp_7m( : , 2), '*', 'pe_ca_3.aps');
...
start @NoCallback
plotHandle = plot( _t, _ca, ...
kemper_exp_8m( : , 1), kemper_exp_8m( : , 2), '*', 'pe_ca_4.aps');
...
start @NoCallback
plotHandle = plot( _t, _ca, ...
kemper_exp_6_ivm( : , 1), kemper_exp_6_ivm( : , 2), '*', 'pe_ca_5.aps');
...
start @NoCallback
plotHandle = plot( _t, _ca, ...
kudo_iv__low_dosem( : , 1), kudo_iv__low_dosem( : , 2), '*', 'pe_ca_6.aps');
...
start @NoCallback
plotHandle = plot( _t, _ca, ...
kudo_iv__low_dosem( : , 1), kudo_iv__low_dosem( : , 2), '*', 'pe_ca_7.aps');
...
uitext = strcat(uitext, "\fs24 Date:\tab\tab\cf1 Thursday, January 22, 2015 at 5:50:20 PM\tab\cf0\par ");
