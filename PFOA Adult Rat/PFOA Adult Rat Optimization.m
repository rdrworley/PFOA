% M file automatically generated by acslXtreme on Thursday, January 29, 2015 at 3:44:54 PM
...
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\pfoa adult rat\kudo_iv__high_dosemm.csv' @Format='Ascii' @Separator='Comma'
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\pfoa adult rat\kemper_exp_6_ivmm.csv' @Format='Ascii' @Separator='Comma'
...
kudo_iv__high_dosemm( : , 1) kudo_iv__high_dosemm( : , 2)
kemper_exp_6_ivmm( : , 1) kemper_exp_6_ivmm( : , 2) ]
...
start @NoCallback
plotHandle = plot( _t, _ca, ...
kudo_iv__high_dosemm( : , 1), kudo_iv__high_dosemm( : , 2), '*', 'pe_ca_6.aps');
...
start @NoCallback
plotHandle = plot( _t, _ca, ...
kemper_exp_6_ivmm( : , 1), kemper_exp_6_ivmm( : , 2), '*', 'pe_ca_7.aps');
...
uitext = strcat(uitext, "\fs24 Date:\tab\tab\cf1 Thursday, January 29, 2015 at 3:44:54 PM\tab\cf0\par ");
