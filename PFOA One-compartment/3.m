%This .m file runs PFOA one-compartment.csl file with data from 2016 Decatur EI participant #3.  
...
%!! s Ke = 0.0002		%fits upper estimate of PFOA exposure
%!! s Ke = 0.000046		%fits average estimate of PFOA exposure 

%!! s Ke = 0.000088		%fits upper estimate of PFOS exposure
!! s Ke = 0.000016		%fits average estimate of PFOS exposure
...
%PFOA Data for participant #3
%serum = [175200, 15.4]

%PFOS Data for participant #3
serum = [500000, 18.1]
