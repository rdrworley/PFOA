...
%!! s Ke = 0.0000347		%fits upper estimate of PFOS exposure
!! s Ke = 0.0000063		%fits average estimate of PFOS exposure
...
%PFOA Data for participant #31
%serum = [394200, 42.4]

%PFOS Data for participant #31
serum = [4370500, 45.9]
