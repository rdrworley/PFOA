%This .m file runs PFOA one-compartment.csl file with data from 2016 Decatur EI participant #9.  
...
%!! s Ke = 0.0000975		%fits upper estimate of PFOA exposure
%!! s Ke = 0.0000225 	%fits average estimate of PFOA exposure 

%!! s Ke = 0.0000455		%fits upper estimate of PFOS exposure
!! s Ke = 0.0000083		%fits average estimate of PFOS exposure
...
%PFOA Data for participant #9
%serum = [ 500000, 31.5]

%PFOS Data for participant #9
serum = [700000, 35.1]
