% M file automatically generated by acslXtreme on Tuesday, July 21, 2015 at 1:09:10 PM
...
load @File='C:\Program Files (x86)\AEgis Technologies\acslX\PFOA\project 1\little_hocking_datam.csv' @Format='Ascii' @Separator='Comma'

OpData = [...
little_hocking_datam( : , 1) little_hocking_datam( : , 2) ]
...
little_hocking_datam( : , 1), little_hocking_datam( : , 2), '*', 'pe_ca_1.aps');
...
uitext = strcat(uitext, "\fs24 Date:\tab\tab\cf1 Tuesday, July 21, 2015 at 1:09:10 PM\tab\cf0\par ");
