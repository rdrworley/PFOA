% M file automatically generated by acslXtreme on Saturday, May 28, 2016 at 2:19:09 PM
...
zzplthdl = plot(_t, senscoef(:,2), 'sa_ca_dwtotal.aps');
set @Preference = BackSlashEscapes;
sertitle(zzplthdl, 0, "ca:dwtotal");
...
uitext = strcat(uitext, "\fs24 Date:\tab\tab\cf1 Saturday, May 28, 2016 at 2:19:09 PM\tab\cf0\par ");
...
% Plot the computed sensitivity coefficients
zzplthdl = plot(_t, senscoef(:,2), 'sa_ca_ingest.aps');
set @Preference = BackSlashEscapes;
sertitle(zzplthdl, 0, "ca:ingest");
set @Preference = NoBackSlashEscapes;
OpResults = [OpResults senscoef];
